...
@app.on_message(filters.command(["رفع ادمن"]) & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command(["تنزيل ادمن"]) & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["الادمنيه", "الادمن"]) & ~BANNED_USERS
)
@language
